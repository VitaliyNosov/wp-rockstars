                        ...
                        <div className="mx-auto max-w-[570px] text-center wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div className="flex items-center justify-center">
                                {button1Text && button1Url && (
                                    <Link href={button1Url} className="text-base font-semibold text-white bg-primary py-4 px-8 hover:bg-opacity-80 mx-2 rounded-md transition duration-300 ease-in-out">
                                        {button1Text}
                                    </Link>
                                )}
