        ...
        <div class="w-full px-4">
          <div
            ...
            <a href="https://uideck.com" target="_blank" rel="nofollow noreferrer"
              ...
              <img src="http://localhost:8081/wp-content/uploads/2025/06/uideck.svg" alt="uideck" />
            </a>
            <a href="https://tailgrids.com" target="_blank" rel="nofollow noreferrer"
              class="flex items-center justify-center lg:max-w-[130px] xl:max-w-[150px] 2xl:max-w-[160px] mx-3 sm:mx-4 xl:mx-6 2xl:mx-8 py-[15px] grayscale hover:grayscale-0 opacity-70 hover:opacity-100 dark:opacity-60 dark:hover:opacity-100 transition">
              <img src="http://localhost:8081/wp-content/uploads/2025/06/tailgrids.svg" alt="tailgrids" />
            </a>
            <a href="https://lineicons.com" target="_blank" rel="nofollow noreferrer"
              class="flex items-center justify-center lg:max-w-[130px] xl:max-w-[150px] 2xl:max-w-[160px] mx-3 sm:mx-4 xl:mx-6 2xl:mx-8 py-[15px] grayscale hover:grayscale-0 opacity-70 hover:opacity-100 dark:opacity-60 dark:hover:opacity-100 transition">
              <img src="http://localhost:8081/wp-content/uploads/2025/06/lineicons.svg" alt="lineicons" />
            </a>
            <a href="https://ayroui.com" target="_blank" rel="nofollow noreferrer"
              class="flex items-center justify-center lg:max-w-[130px] xl:max-w-[150px] 2xl:max-w-[160px] mx-3 sm:mx-4 xl:mx-6 2xl:mx-8 py-[15px] grayscale hover:grayscale-0 opacity-70 hover:opacity-100 dark:opacity-60 dark:hover:opacity-100 transition">
              <img src="http://localhost:8081/wp-content/uploads/2025/06/ayroui.svg" alt="ayroui" />
            </a>
            <a href="https://plainadmin.com" target="_blank" rel="nofollow noreferrer"
              class="flex items-center justify-center lg:max-w-[130px] xl:max-w-[150px] 2xl:max-w-[160px] mx-3 sm:mx-4 xl:mx-6 2xl:mx-8 py-[15px] grayscale hover:grayscale-0 opacity-70 hover:opacity-100 dark:opacity-60 dark:hover:opacity-100 transition">
              <img src="http://localhost:8081/wp-content/uploads/2025/06/plainadmin.svg" alt="plainadmin" />
            </a>
          </div>
        </div>
      </div>
...
<div class="slider-container" id="sliderContainer">
  <div id="sliderTrack" class="slider-track" >
    ...
    <a href="#" class="slide"><img src="http://localhost:8081/wp-content/uploads/2025/06/dfgdfg2.png" alt="Проект 2" /></a>
    <a href="#" class="slide"><img src="http://localhost:8081/wp-content/uploads/2025/06/dfgdfg3.png" alt="Проект 3" /></a>
    <a href="#" class="slide"><img src="http://localhost:8081/wp-content/uploads/2025/06/dfgdfg4.png" alt="Проект 4" /></a>
  </div>
</div>
        ...
        <div class="flex flex-wrap items-center mx-[-16px]">
          ...
          <div class="w-full lg:w-1/2 px-4">
            <div class="text-center lg:text-right wow fadeInUp" data-wow-delay=".2s">
              <img src="http://localhost:8081/wp-content/uploads/2025/06/about-image-2.svg" alt="about-image" class="max-w-full mx-auto lg:mr-0" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-wrap items-center mx-[-16px]">
        <div class="w-full lg:w-1/2 px-4">
          <div class="text-center lg:text-left mb-12 lg:mb-0 wow fadeInUp" data-wow-delay=".15s">
            <img src="http://localhost:8081/wp-content/uploads/2025/06/about-image.svg" alt="about image" class="max-w-full mx-auto lg:ml-0" />
          </div>
        </div>
        <div class="w-full lg:w-1/2 px-4">
          ...
          <div class="shadow-one bg-white dark:bg-[#1D2144] rounded-md p-8 lg:px-5 xl:px-8 mb-10 wow fadeInUp"
            ...
            <div class="flex items-center">
              <div class="rounded-full overflow-hidden max-w-[50px] w-full h-[50px] mr-4">
                <img src="http://localhost:8081/wp-content/uploads/2025/06/auth-01.png" alt="image" />
              </div>
              <div class="w-full">
