(function () {
    ...
    // Ensure the variable exists before assigning, though WordPress handles this.
    const chatWidgetConfig = (typeof rockStarsChatConfig !== 'undefined') ? rockStarsChatConfig : {};
