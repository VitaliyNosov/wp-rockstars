 ...
 *
 * Template Name: Page Template UI UX
 * 
 * @package Rock_Star
 */
...
<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
    <div class="lg:col-span-3">
      ...
      <p class="mt-3 text-lg dark:text-white dark:text-neutral-400">Introducing a new way for your brand to reach the creative community.</p>

      <div class="mt-5 lg:mt-8 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
        <div class="w-full sm:w-auto">
          <label for="hero-input" class="sr-only">Search</label>
          <input type="text" id="hero-input" name="hero-input" class="w-full border border-transparent dark:bg-[#242B51] rounded-md shadow-one dark:shadow-signUp py-3 px-6 text-body-color text-base placeholder-body-color outline-none focus-visible:shadow-none focus:border-primary" placeholder="Enter work email">
        </div>
      ...
      <div class="mt-6 lg:mt-12">
        <span class="text-xs font-medium dark:text-white uppercase dark:text-neutral-200">Trusted by:</span>
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid md:grid-cols-2 gap-12">
    <div class="lg:w-3/4">
      <h2 class="text-3xl dark:text-white font-bold lg:text-4xl dark:text-white">
        Collaborative tools to design better user experience
      </h2>
      <p class="mt-3 dark:text-white dark:text-neutral-400">
    ...
    <div class="space-y-6 lg:space-y-10">
      ...
      <div class="flex gap-x-5 sm:gap-x-8">
        ...
        <div class="grow">
          <h3 class="text-base sm:text-lg font-semibold dark:text-white dark:text-neutral-200">
    ...
    <div class="mt-5 sm:mt-10 lg:mt-0 lg:col-span-5">
      <div class="space-y-6 sm:space-y-8">
        ...
        <div class="space-y-2 md:space-y-4">
          <h2 class="font-bold text-3xl lg:text-4xl dark:text-white dark:text-neutral-200">
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="mx-auto max-w-2xl mb-8 lg:mb-14 text-center">
    <h2 class="text-3xl lg:text-4xl dark:text-white font-bold dark:text-neutral-200">
      Explore tools
    </h2>
    <p class="mt-3 dark:text-white dark:text-neutral-200">
  ...
  <div class="mx-auto max-w-3xl grid grid-cols-3 gap-6 lg:gap-8">
    ...
    <div class="text-center">
      <svg class="shrink-0 size-7 md:size-9 mx-auto dark:text-white dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="10" height="14" x="3" y="8" rx="2"/><path d="M5 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2h-2.4"/><path d="M8 18h.01"/></svg>
      <div class="mt-2 sm:mt-6">
        <h3 class="sm:text-lg font-semibold dark:text-white dark:text-neutral-200">
          Responsive
        </h3>
      </div>
    </div>
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="sm:w-1/2 xl:w-1/3 mx-auto text-center mb-6">
    <h2 class="text-xl font-semibold md:text-2xl md:leading-tight dark:text-white dark:text-neutral-200">Trusted by Open Source, enterprise, and more than 99,000 of you</h2>
  </div>
  <!-- End Title -->
  ...
  <div class="my-8 md:my-16 grid grid-cols-3 sm:flex sm:justify-center gap-6 sm:gap-x-12 lg:gap-x-20">
    ...
    <a class="shrink-0 transition hover:-translate-y-1" href="#">
      <svg class="size-6 md:size-10 mx-auto sm:mx-0" width="48" height="50" viewBox="0 0 1280 1280" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="grid grid-cols-12 sm:flex sm:justify-center gap-6 sm:gap-x-12 lg:gap-x-20">
    <div class="col-span-6 text-center">
      <h4 class="text-xl md:text-3xl font-semibold dark:text-white dark:text-neutral-200">
        250+
      </h4>
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <a class="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-hidden focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5 dark:border-neutral-700 dark:hover:border-transparent dark:hover:shadow-black/40 dark:focus:border-transparent dark:focus:shadow-black/40" href="#">
      ...
      <div class="mt-auto flex items-center gap-x-3">
        ...
        <div>
          <h5 class="text-sm dark:text-white dark:text-neutral-200">By Lauren Waller</h5>
        </div>
      </div>
    </a>
    <!-- End Card -->
    ...
    <a class="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-hidden focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5 dark:border-neutral-700 dark:hover:border-transparent dark:hover:shadow-black/40 dark:focus:border-transparent dark:focus:shadow-black/40" href="#">
      ...
      <div class="mt-auto flex items-center gap-x-3">
        ...
        <div>
          <h5 class="text-sm dark:text-white dark:text-neutral-200">By Aaron Larsson</h5>
        </div>
      </div>
    </a>
    <!-- End Card -->
  ...
  <div class="max-w-xl text-center mx-auto">
    ...
    <form>
      <div class="mt-5 lg:mt-8 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
        <div class="w-full">
          <label for="hero-input" class="sr-only">Search</label>
          <input type="text" id="hero-input" name="hero-input" class="w-full border border-transparent dark:bg-[#242B51] rounded-md shadow-one dark:shadow-signUp py-3 px-6 text-body-color text-base placeholder-body-color outline-none focus-visible:shadow-none focus:border-primary" placeholder="Enter your email">
        </div>
        <a class="w-full sm:w-auto whitespace-nowrap py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
          Subscribe
        </a>
      </div>
    </form>
