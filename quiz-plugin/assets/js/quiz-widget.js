...
(function () {
    ...
    class QuizWidget {
        constructor() {
            this.currentStep = 1;
            this.totalSteps = (typeof quiz_p_ajax !== 'undefined' && quiz_p_ajax.total_steps) ? parseInt(quiz_p_ajax.total_steps) + 1 : (window.QUIZ_TOTAL_STEPS || 10);
            this.answers = {};
        ...
        async submit() {
            ...
            try {
                ...
                formData.append('action', 'quiz_p_submit');
                formData.append('nonce', quiz_p_ajax.nonce);
                ...
                const response = await fetch(quiz_p_ajax.ajax_url, {
                    method: 'POST',
                    body: formData
                });
